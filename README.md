![JOHNY SINS](https://telegra.ph/file/6a95a97bee10856c5c19d.jpg)
# JOHNY SINS Robot 
...
A modular Telegram Python bot running on python3 with a sqlalchemy database and an entirely themed persona to make MIAKHALIFA suitable for Anime and Manga group chats. 

Can be found on telegram as [SaitamaRobot](https://t.me/missmiakhalifabot).

The Support group can be reached out to at [One Punch Support](https://t.me/miakhalifachatgroup), where you can ask for help about [SaitamaRobot](https://t.me/SaitamaRobot), discover/request new features, report bugs, and stay in the loop whenever a new update is available. 

News channel as at [One Punch Updates](https://t.me/aboutmiakhalifabot) 

## How to setup/deploy.

### Read these notes carefully before proceeding 
 - Edit any mentions of @aboutmiakhalifabot to your own support chat
...
class Development(Config):
    OWNER_ID = 1209574071  # your telegram ID
    OWNER_USERNAME = "Gamerfucker"  # your telegram username
